...
do
  ...
  local servers = {
    ...
    -- Python ownership: ty provides language intelligence; Ruff provides diagnostics and code actions.
    ty = {},
    ruff = {
...
do
  ...
  local parsers = { 'bash', 'c', 'diff', 'html', 'java', 'json', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'rust', 'vim', 'vimdoc' }
